...
export default function ConfirmExitModal({ onExit, onContinue }: Props) {
  return (
    ...
    <div className="absolute inset-0 z-20 flex items-center justify-center">
      ...
      {/* 작은 확인 카드 */}
      <div className="relative w-[520px] bg-white rounded-xl shadow-xl px-10 py-10">
        <p className="text-center text-xl font-extrabold text-[#222829] mb-8">
          정말로 동료평가를 그만두시겠습니까?
        </p>
        ...
        <div className="flex items-center justify-center gap-6">
          <button
            onClick={onExit}
            className="w-[180px] h-14 rounded-md font-extrabold
